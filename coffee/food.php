...
$con= new Dbconn();
  $conn=$con->DbConnect();
   $id=$_GET['id'];
   $count=0;
	$sqlQry = $conn->query("SELECT * FROM tbl_food WHERE id=$id ");
	if ($sqlQry->num_rows > 0) {
		$rows = $sqlQry->fetch_array();
		  ...
		  $insert_perorder="INSERT INTO tbl_perorderfood (name,detail,image,price) VALUES('".$name."','".$detail."','".$image."','".$price."')";
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Order Food</h1>
		...
		<section class="ftco-section ftco-cart">
    			...
    			<div class="col-md-12 ftco-animate" style="margin-top: 10px">
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <tbody >	
                  <?php
                   $sqlQry = $conn->query("SELECT * FROM tbl_perorderfood where status=0 ");
                   if ($sqlQry->num_rows > 0) {
                       while ($rows = $sqlQry->fetch_array()) {
                           ?>
                  <tr class='text-center'>
                    <td class='product-remove'><a href='#'><span class='icon-close'></span></a></td>            
                    <td class='image-prod'><div class='img' style="background-image:url(../desboard/themesbrand.com/lexa/html/horizontal-teal/upload/food/<?php echo $rows['image']?>)"></div></td>
			...
			<div class="row justify-content-end">
        		<div class="col col-lg-9 col-md-6 mt-5 cart-wrap ftco-animate">
						<form action="test2.php" class="billing-form ftco-bg-dark p-3 p-md-5" method="POST">
               ...
               <input type="submit" class="btn btn-primary py-3 px-4"  name="btn" >
                ...
                <span>Subtotal</span>
                <?php
                   $sqlQry = $conn->query("SELECT Sum(price) total FROM tbl_perorderfood where status=0 ");
                   if ($sqlQry->num_rows > 0) {
                       while ($rows = $sqlQry->fetch_array()) {
                           ?>
