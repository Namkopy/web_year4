...
<?php
   ...
   $con= new Dbconn();   
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO tbl_cafe (`name`,`size`,`type`,`detail`,`image`,`price`) VALUES ('".$name."','".$size."','".$type."','".$des."','".$img."','".$price."')";
                ...
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title"> Create Cafe</h4>
                                ...
                                <div class="form-group row" id="type">
                                    <div class="col-sm-12">
                                        <select class="form-control"  name="type">
                                            ...
                                            <option value="L">Ice </option>
                                            <option value="M">Shake</option>
                                            <option value="S">Hot</option>
                                        </select> 
                                    </div>
                                </div>
                                </div> 
