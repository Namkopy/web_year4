...
<?php
  ...
  $conn=$con->DbConnect();
   ...
   $sqlQry = $conn->query("SELECT * FROM tbl_cafe");
        
   $rule="SELECT rule from tbl_accountlogin where rule='edit'";
   $str=$conn->query($rule);
                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-6">                                        
                                            <h4 class="mt-0 header-title">View Product Of Cafe</h4>                                                                          
                                    </div>                                  
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    while ($rows = $sqlQry->fetch_array()) {
                                        ...
                                        echo "<tr>";                                           
                                            ...
                                            echo "<td>{$rows[3]}</td>";
                                            echo "<td>{$rows[4]}</td>";
                                            echo "<td  style='text-align: center'><img src='upload/cafe/{$rows[5]}' alt='' style=' height: 50px; width: 50px;text-align: center'></td>";
                                            echo "<td>{$rows[6]} ៛</td>";                                            
                                            if($rows[7]=="0"){
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    while ($rows = $sqlQry->fetch_array()) {
                                        ...
                                        echo "<tr>";                                           
                                            ...
                                            <a  href='editcafe.php?id={$rows['id']}'>
          ...
          function myadd(str){    
            ...
            //   alert('Test'+text.innerText);
              if(text.innerText=='Inactive'){
                ...
                xmlhttp.open("GET","ajax/cafe/check.php?q="+str,true);
                xmlhttp.send();
                ...
                xmlhttp.open("GET","ajax/cafe/uncheck.php?b="+str,true);
                xmlhttp.send();
