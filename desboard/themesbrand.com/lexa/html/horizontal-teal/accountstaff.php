...
<?php
  ...
  $conn=$con->DbConnect();
   ...
   $sqlQry = $conn->query("SELECT * FROM v_login");
                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-6">                                        
                                            <h4 class="mt-0 header-title">Create Account Staff</h4>                                                                          
                                    </div>
                                    <?Php if($_SESSION['rule']=='save'){?>
                                    <div class="col-6" style="text-align: right; ">
                                        <div class="row" >
                                            <div class="col-12">                                                                                        <!-- Button trigger modal -->
                                                <a href="addaccountstaff.php">
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    while ($rows = $sqlQry->fetch_array()) {
                                        ...
                                        echo "<td>{$rows['name']}</td>";
                                            ...
                                            echo "<td  style='text-align: center'><img src='upload/staff/{$rows['image']}' alt='' style='height: 50px; width: 40px;text-align: center'></td>";
                                            echo"<td style='text-align: center'>                                      
                                            <a href='editaccountstaff.php?id={$rows['Username']}'>
          ...
          function myadd(str){    
            ...
            //   alert('Test'+text.innerText);
              if(text.innerText=='Inactive'){
                ...
                xmlhttp.open("GET","ajax/drink/check.php?q="+str,true);
                xmlhttp.send();
                ...
                xmlhttp.open("GET","ajax/drink/uncheck.php?b="+str,true);
                xmlhttp.send();
