...
<?php
 ...
 $conn=$con->DbConnect();
  ...
  $sqlQry = $conn->query("SELECT * FROM tbl_perordercafe where status=1 group by phone ");
                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-6">                                        
                                            <h4 class="mt-0 header-title">View Customer order Cafe</h4>                                                                          
                                    </div>
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    while ($rows = $sqlQry->fetch_array()) {     
                                        echo "<tr>";       
                                            ...
                                            <a  href='viewcafe.php?id={$rows['phone']}'>
