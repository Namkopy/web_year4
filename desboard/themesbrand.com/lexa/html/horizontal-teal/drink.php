...
<?php
  ...
  $conn=$con->DbConnect();
   ...
   $sqlQry = $conn->query("SELECT * FROM tbl_drink");
                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-6">                                        
                                            <h4 class="mt-0 header-title">View Product Of Drink</h4>                                                                          
                                    </div>
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    ...
                                    while ($rows = $sqlQry->fetch_array()) {
                                        ...
                                        echo "<tr>";                                           
                                            ...
                                            echo "<td>{$rows[2]}</td>";
                                            echo "<td>{$rows[3]}</td>";
                                            echo "<td  style='text-align: center'><img src='upload/drink/{$rows[4]}' alt='' style='height: 50px; width: 50px;text-align: center'></td>";
                                            echo "<td>{$rows[5]} ៛</td>";                                            
                                            if($rows[6]=="0"){
                                ...
                                <?php if($sqlQry->num_rows > 0){
                                    while ($rows = $sqlQry->fetch_array()) {
                                        ...
                                        //          }
                                            ...
                                            <a  href='editdrink.php?id={$rows['id']}'>
